export const customerRoutes = [
    ...
    {
        path: 'products',
        loadComponent: () => import('./pages/product-catalog/product-catalog').then((m) => m.ProductCatalogComponent),
    },
    {
        path: 'products/:id',
    ...
    },
    {
        ...
        loadComponent: () => import('./pages/return-request/return-request').then((m) => m.ReturnRequestComponent),
    },
    {
        path: 'profile',
